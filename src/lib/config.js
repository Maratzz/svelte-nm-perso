export const title = "Nico Moisson"
export const description = "C'est mon site perso, il y en a plein comme lui sur Internet mais celui-là c'est le mien"
export const url = "https://nicolasmoisson.fr"
