...
<div>
  ...
  <p>Vous avez vu une faute de frappe (ouh!), un comportement bizarre sur mobile (mon pire ennemi).</p>

  <p>Vous avez tellement apprécié un texte que vous voulez m'envoyer des mots doux (❤️) ou au contraire m'incendier (🔥🔥🔥) pour mon opinion éclatée au sol sur <i>[votre jeu préféré]</i></p>

  <p>Vous aimeriez connaître mon avis sur <i>[insérer votre deuxième jeu préféré]</i>, ou suggérer que je joue à <i>[insérer votre troisième jeu préfé</i>-okay on a saisi<i>]</i></p>

  <p>Voici les différentes méthodes pour me contacter. Toute sollicitation sur une autre plateforme que celles listées ci-dessous sera ignorée. Pareil si c'est pour de la publicité, de l'arnaque ou des maraboutages.</p>

  <p>Je ne mords pas mais j'ai la correspondance irrégulière, ne m'en voulez pas trop !</p>
  ...
  <p><b>Psst!</b> si vous voulez faire plus que m'envoyer des messages, vous pouvez aussi <a href="/soutien"> m'envoyer un peu d'argent ou des jeux</a> pour garder les lumières allumées et les doigts occupés.</p>
